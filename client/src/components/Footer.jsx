...
// Added useForm for handling the newsletter subscription
 ...
 */
const Footer = () => {
    // Initialize react-hook-form for the newsletter
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12 pb-12 border-b border-gray-400/50">
                    ...
                    <div className="md:col-span-1">
                        ...
                        {/* Newsletter Signup Form (Converted) */}
                        <form onSubmit={handleSubmit(handleSubscription)}>
                            <div className="flex flex-col sm:flex-row gap-2">
                                <input 
                                    ...
                                    className={`px-4 py-2 w-full sm:w-auto grow bg-white rounded-lg border text-sm ${
                                        errors.email ? 'border-red-500' : 'border-gray-300 focus:ring-2 focus:ring-gray-500 focus:border-gray-500'
                                    }`}
                                />
                                <button 
                        ...
                        {isSubscribed && (
                            <p className="text-green-600 text-xs font-semibold mt-2">Subscribed successfully!</p>
                        )}
                    </div>

                    {/* Column 2: Explore Links */}
                    <div className="md:col-start-3 md:col-span-1 lg:col-start-3 lg:col-span-1">
                        <h3 className="text-lg font-semibold mb-4 opacity-0 md:opacity-100 h-0 md:h-auto">Quick Links</h3>
                    ...
                    <div className="lg:col-start-4 lg:col-span-1">
                         <h3 className="text-lg font-semibold mb-4 opacity-0 md:opacity-100 h-0 md:h-auto">Legal</h3>
